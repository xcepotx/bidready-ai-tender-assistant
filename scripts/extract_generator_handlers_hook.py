...
HOOK = Path("apps/web/src/hooks/useTenderGenerators.js")
...
def main():
    ...
    app_backup = APP.with_suffix(".jsx.bak.extract-generator-handlers-hook")
...
'''
    ...
    if 'import { useTenderGenerators } from "./hooks/useTenderGenerators.js";' not in new_text:
...
'''
    ...
    if "useTenderGenerators({" not in new_text:
        insert_at = parse_hook_call_end(new_text, "useTenderBulkUpdates")
