...
extract_one() {
  ...
  echo
  echo "============================================================"
  echo "Extracting detail component: ${name}"
  echo "============================================================"
...
extract_one "ResponseItemDetail"
extract_one "ProposalSectionDetail"
extract_one "EvidenceItemDetail"
extract_one "ActionItemCard"
