...
HOOK = Path("apps/web/src/hooks/useTenderScoreRiskActionUpdates.js")
...
def main():
    ...
    app_backup = APP.with_suffix(".jsx.bak.extract-score-risk-action-update-handlers-hook")
...
'''
    ...
    if 'import { useTenderScoreRiskActionUpdates } from "./hooks/useTenderScoreRiskActionUpdates.js";' not in new_text:
...
'''
    ...
    if "useTenderScoreRiskActionUpdates({" not in new_text:
        insert_at = parse_hook_call_end(new_text, "useTenderPostMvpUpdates")
