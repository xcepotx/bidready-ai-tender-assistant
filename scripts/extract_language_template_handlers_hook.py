...
HOOK = Path("apps/web/src/hooks/useTenderLanguageTemplate.js")
...
def main():
    ...
    app_backup = APP.with_suffix(".jsx.bak.extract-language-template-handlers-hook")
...
'''
    ...
    if 'import { useTenderLanguageTemplate } from "./hooks/useTenderLanguageTemplate.js";' not in new_text:
...
'''
    ...
    if "useTenderLanguageTemplate({" not in new_text:
        insert_at = parse_hook_call_end(new_text, "useTenderMetadataDecisionGate")
