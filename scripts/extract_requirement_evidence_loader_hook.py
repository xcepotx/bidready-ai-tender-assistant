...
HOOK = Path("apps/web/src/hooks/useTenderRequirementEvidence.js")
...
def main():
    ...
    app_backup = APP.with_suffix(".jsx.bak.extract-requirement-evidence-loader-hook")
...
'''
    ...
    if 'import { useTenderRequirementEvidence } from "./hooks/useTenderRequirementEvidence.js";' not in new_text:
...
'''
    ...
    if "useTenderRequirementEvidence({" not in new_text:
        insert_at = parse_hook_call_end(new_text, "useTenderProjectIntake")
