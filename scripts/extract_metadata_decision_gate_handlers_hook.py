...
HOOK = Path("apps/web/src/hooks/useTenderMetadataDecisionGate.js")
...
def main():
    ...
    app_backup = APP.with_suffix(".jsx.bak.extract-metadata-decision-gate-handlers-hook")
...
'''
    ...
    if 'import { useTenderMetadataDecisionGate } from "./hooks/useTenderMetadataDecisionGate.js";' not in new_text:
...
'''
    ...
    if "useTenderMetadataDecisionGate({" not in new_text:
        insert_at = parse_hook_call_end(new_text, "useTenderScoreRiskActionGenerators")
