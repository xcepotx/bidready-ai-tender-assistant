...
HOOK = Path("apps/web/src/hooks/useTenderPostMvpGenerators.js")
...
def main():
    ...
    app_backup = APP.with_suffix(".jsx.bak.extract-post-mvp-generator-handlers-hook")
...
'''
    ...
    if 'import { useTenderPostMvpGenerators } from "./hooks/useTenderPostMvpGenerators.js";' not in new_text:
...
'''
    ...
    if "useTenderPostMvpGenerators({" not in new_text:
        insert_at = parse_hook_call_end(new_text, "useTenderGenerators")
