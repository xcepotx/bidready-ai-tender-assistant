...
HOOK = Path("apps/web/src/hooks/useTenderApprovalDecision.js")
...
def main():
    ...
    app_backup = APP.with_suffix(".jsx.bak.extract-approval-decision-handlers-hook")
...
'''
    ...
    if 'import { useTenderApprovalDecision } from "./hooks/useTenderApprovalDecision.js";' not in new_text:
...
'''
    ...
    if "useTenderApprovalDecision({" not in new_text:
        insert_at = parse_hook_call_end(new_text, "useTenderLanguageTemplate")
