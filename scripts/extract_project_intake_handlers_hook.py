...
HOOK = Path("apps/web/src/hooks/useTenderProjectIntake.js")
...
def main():
    ...
    app_backup = APP.with_suffix(".jsx.bak.extract-project-intake-handlers-hook")
...
'''
    ...
    if 'import { useTenderProjectIntake } from "./hooks/useTenderProjectIntake.js";' not in new_text:
...
'''
    ...
    if "useTenderProjectIntake({" not in new_text:
        insert_at = parse_hook_call_end(new_text, "useTenderApprovalDecision")
