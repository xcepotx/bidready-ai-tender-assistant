...
function App() {
  ...
  async function loadProjectData(projectId) {
    ...
    try {
      const [docs, reqs, qs, responseItems, proposalSections, evidenceItems, gate, gateHistory, addendumImpactData, approvalData, complianceData, riskItemsData, actionItemsData, language, audits, summary, metadata, brief] = await Promise.all([
...
function ProjectViewTabs({ activeProjectView, setActiveProjectView, addendumImpacts = { summary: null, items: [] }, decisionGateHistory = { summary: null, events: [] }, approvalWorkflow = { summary: null, request: null, steps: [] }, complianceScorecard = { summary: null, items: [] }, riskItems = [], actionItems = [] }) {
  const tabs = [
